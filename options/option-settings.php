								...
								<div class="col-md-12 col-sm-6 op_tem site_template"
									...
									<div class="selected_template">
										...
										<h4 class="op_name"><?php  echo esc_html__('Theme ', 'NLS_TEXT_DOMAIN') . esc_html($i); ?>&nbsp;&nbsp;<a
												...
												href="<?php echo esc_url($nls_demo_temp); ?>"><?php esc_html_e('', 'NLS_TEXT_DOMAIN'); ?></a>
										</h4>
									</div>
								</div>
								<?php } ?>
                                ...
                                for ($i=1;$i<=$wl_nls_options['total_Social_links']; $i++) {	?>
									<div class="col-md-12 form-group"
										...
										<div class="row">
											...
											<div class="col-md-6">
												<label><?php esc_html_e('Open As New Tab', 'NLS_TEXT_DOMAIN');?><?php echo esc_html__(' ', 'NLS_TEXT_DOMAIN').esc_html($i);
												print_r($wl_nls_options['social_link_tab_'.$i]); ?></label><br>
				...
				<div class="tab-content">
					<form action="post" id="weblizar_nls_subscriber_option">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<label><?php esc_html_e('Get more font-awesome icon', 'NLS_TEXT_DOMAIN'); ?>
										<a href="https://fontawesome.com/v5/icons/" target="_blank"><?php esc_html_e('click here', 'NLS_TEXT_DOMAIN'); ?></a></label>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">
						...
						<div class="col-md-12 form-group">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" name="sub_form_button_f_name"
												id="sub_form_button_f_name" value="<?php echo esc_attr($wl_nls_options['sub_form_button_f_name']); ?>"
												size="20">
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" name="sub_form_button_l_name"
												id="sub_form_button_l_name" value="<?php echo esc_attr($wl_nls_options['sub_form_button_l_name']); ?>"
												size="20">
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" name="sub_form_button_text"
											id="sub_form_button_text" value="<?php echo esc_attr($wl_nls_options['sub_form_button_text']); ?>"
											size="20">
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" name="sub_form_subscribe_title"
											id="sub_form_subscribe_title" value="<?php echo esc_attr($wl_nls_options['sub_form_subscribe_title']); ?>"
											size="20">
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<input type="text" class="color no-sliders" name="sub_form_button_ht_color"
											id="color" value="<?php echo esc_attr($wl_nls_options['sub_form_button_ht_color']); ?>" />
									</div>
								</div>
							</div>
							<div class="col-md-12 checkbox">
									...
									<div class="col-md-6">
										<div class="color-picker" style="position: relative">
											<input type="text" class="color no-sliders" name="sub_form_button_hb_color"
												id="color" value="<?php echo esc_attr($wl_nls_options['sub_form_button_hb_color']); ?>" />
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" name="sub_form_subscribe_seuccess_message" id="sub_form_subscribe_seuccess_message" value="<?php echo esc_attr($wl_nls_options['sub_form_subscribe_seuccess_message']); ?>">
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-4">
										...
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Add a text for Invalid Email Id Message", "NLS_TEXT_DOMAIN");?>"><i
													class="fas fa-info-circle tt-icon"></i></a></label>
									</div>
									<div class="col-md-8">
										<input type="text" class="form-control"
											name="sub_form_subscribe_invalid_message" id="sub_form_subscribe_invalid_message" value="<?php echo esc_attr($wl_nls_options['sub_form_subscribe_invalid_message']); ?>">
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-4">
										...
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Add a text for a confirmation message.", "NLS_TEXT_DOMAIN");?>"><i
													class="fas fa-info-circle tt-icon"></i></a></label>
									</div>
									<div class="col-md-8">
										<input type="text" class="form-control"
											name="sub_form_subscribe_confirm_success_message" id="sub_form_subscribe_confirm_success_message" value="<?php echo esc_attr($wl_nls_options['sub_form_subscribe_confirm_success_message']); ?>">
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-4">
										...
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Add a text for a already subscribed message.", "NLS_TEXT_DOMAIN");?>"><i
													class="fas fa-info-circle tt-icon"></i></a></label>
									</div>
									<div class="col-md-8">
										<input type="text" class="form-control"
											name="sub_form_subscribe_already_confirm_message" id="sub_form_subscribe_already_confirm_message" value="<?php echo esc_attr($wl_nls_options['sub_form_subscribe_already_confirm_message']); ?>">
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control"
											name="sub_form_invalid_confirmation_message" id="sub_form_invalid_confirmation_message" value="<?php echo esc_attr($wl_nls_options['sub_form_invalid_confirmation_message']); ?>">
									</div>
								</div>
							</div>
						</div>
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php esc_attr_e('Restore Defaults', 'NLS_TEXT_DOMAIN');?>" onclick="weblizar_nls_option_data_reset('subscriber_option');">
							<input class="button button-primary left" type="button" value="<?php esc_attr_e('Save Options', 'NLS_TEXT_DOMAIN');?>" onclick="weblizar_nls_option_data_save('subscriber_option')">
						</div>
					</form>
				</div>
			</div>
